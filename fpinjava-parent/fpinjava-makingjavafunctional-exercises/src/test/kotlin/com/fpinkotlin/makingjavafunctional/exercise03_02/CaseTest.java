...
public class CaseTest {
  ...
  public void testMcaseSupplierOfBooleanSupplierOfResultOfT() {
    com.fpinjava.makingjavafunctional.exercise03_02.Case<Integer> c1 = com.fpinjava.makingjavafunctional.exercise03_02.Case.mcase(() -> true, () -> Result.success(4));
    ...
    com.fpinjava.makingjavafunctional.exercise03_02.Case<Integer> c2 = com.fpinjava.makingjavafunctional.exercise03_02.Case.mcase(() -> false, () -> Result.failure("failure"));
  ...
  public void testMcaseSupplierOfResultOfT() {
    com.fpinjava.makingjavafunctional.exercise03_02.Case<Integer> c1 = Case.mcase(() -> Result.success(4));
    assertTrue(c1._1.get());
    Wrapper<Integer> success1 = new Wrapper<>();
    Wrapper<String> failure1 = new Wrapper<>();
    c1._2.get().bind(x -> success1.value = x, y -> failure1.value = y);
